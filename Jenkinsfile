                ...
                withCredentials([string(credentialsId: 'PCC_CONSOLE_URL', variable: 'CONSOLE'), string(credentialsId: 'PCC_PASS', variable: 'PASS'), string(credentialsId: 'PCC_USER', variable: 'USER')])
                 {
                        ...
                        script { 
                          docker.image('bridgecrew/checkov:latest').inside("--entrypoint=''") {
                              ...
                              sh 'checkov -d . --framework sca_package -o cli --bc-api-key c0a0e49b-d9ac-4e92-99f2-e42f044ec7c5::0c8VXZBBM57RawBl6DdNooQrHN8= --prisma-api-url https://api.prismacloud.io '
