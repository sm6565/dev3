pipeline {
  ...
  stage('Scan Images') { 
            ...
            chmod a+x ./twistcli
             ./twistcli images scan --address https://us-east1.cloud.twistlock.com --user c0a0e49b-d9ac-4e92-99f2-e42f044ec7c5  --password 0c8VXZBBM57RawBl6DdNooQrHN8= --details webapp1 ''' } 
           }  
